      ...
      <div className="py-16">
        <div className="container max-w-7xl">
          <div className="relative">
            <MagicContainer className="relative z-10 grid grid-cols-6 gap-3">
              {/* First card */}
              <MagicCard id="card" className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
                <div>
                  <div className="relative col-span-full overflow-hidden p-8">
                    <svg
              ...
              <MagicCard id="card" className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
                <div>
                  ...
                  <div className="relative z-10 mt-8 space-y-1.5 text-center">
                    ...
                    <p className="text-muted-foreground">
                      We take security seriously. Our product is built with
              ...
              <MagicCard id="card" className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
                <div>
                  ...
                  <div className="relative z-10 mt-8 space-y-1.5 text-center">
                    ...
                    <p className="text-muted-foreground">
                      Our product is built with performance in mind. We make
                      sure Sentinel will always be quick and responsive.
                    </p>
                  </div>
                </div>
              </MagicCard>
              ...
              {/* Second row */}
              <MagicCard id="card" className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-3">
                <div className="grid sm:grid-cols-2">
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:bg-white/5 dark:before:border-white/5 dark:before:bg-white/5">
                      <Icons.barchart className="size-full p-2 text-indigo-500" />
                    </div>
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground">
                        We provide real-time insights into your server&apos;s
                        mitigation and member activity. This allows you to make
                        informed decisions.
                      </p>
                    </div>
                  </div>
              ...
              <MagicCard id="card" className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-3">
                <div className="grid h-full sm:grid-cols-2">
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:bg-white/5 dark:before:border-white/5 dark:before:bg-white/5">
                      <Icons.userSearch className="m-auto size-6 text-indigo-500" />
                    </div>
                    <div className="space-y-2">
                      <h2 className="text-lg font-medium text-foreground">
                        Accurate Detection
                      ...
                      <p className="text-muted-foreground">
                        We constantly improve our detection alogrithms to ensure
                        accurate and reliable detections, so your genuine
                        members can actually enjoy your server.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                      <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                        <span className="block h-fit rounded-md border bg-muted/50 px-2 py-1 text-xs">
                          <Icons.userCheck className="inline-flex size-3 text-green-500" />{" "}
                          ethan
                        </span>
                        <div className="size-7 ring-4 ring-background">
                          <Image
                            ...
                            src="/images/lain/TV_MMMMM_3.gif"
                            alt="avatar"
                            unoptimized
                          />
                        </div>
                      ...
                      <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                        <div className="size-8 ring-4 ring-background">
                          <Image
                            ...
                            height={100}
                            className="size-full rounded-full border"
                            src="/images/lain/lon.gif"
                            alt="avatar"
                            unoptimized
                          />
                        </div>
                        <span className="block h-fit rounded-md border bg-muted/50 px-2 py-1 text-xs">
                          <Icons.userX className="inline-flex size-3 text-red-500" />{" "}
                          paris
                        </span>
                      </div>
                      <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
